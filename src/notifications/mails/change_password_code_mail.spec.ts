...
import { ChangePasswordCodeMail } from './change_password_code_mail';

describe('ChangePasswordCodeMail', () => {
  const mockUser = {
    id: 'user-123',
  ...
  describe('constructor', () => {
    it('should set to email from user', () => {
      const mail = new ChangePasswordCodeMail(mockUser as UserModel, '123456', '2025-01-01 12:00:00');
  ...
  describe('properties', () => {
    it('should have correct subject and view', () => {
      const mail = new ChangePasswordCodeMail(mockUser as UserModel, '123456', '2025-01-01 12:00:00');
      expect(mail.subject).toBe('Change Password Code - OneDosh');
      expect(mail.view).toBe('change_password_code');
    });
  });
  ...
  describe('prepare', () => {
    ...
    it('should use first_name when username not provided', async () => {
      ...
      const mail = new ChangePasswordCodeMail(userWithoutUsername as UserModel, '123456', '2025-01-01 12:00:00');
      const data = await mail.prepare();
    ...
    it('should use default username when username and first_name not provided', async () => {
      ...
      const mail = new ChangePasswordCodeMail(userWithoutName as UserModel, '123456', '2025-01-01 12:00:00');
      const data = await mail.prepare();
