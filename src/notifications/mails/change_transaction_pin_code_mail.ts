...
export class ChangeTransactionPinCodeMail implements MailerManager {
  public subject = 'Change Transaction PIN Code - OneDosh';
  public view = 'change_transaction_pin_code';
