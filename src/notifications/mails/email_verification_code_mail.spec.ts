...
import { EmailVerificationCodeMail } from './email_verification_code_mail';

describe('EmailVerificationCodeMail', () => {
  const mockUser = {
    id: 'user-123',
  ...
  describe('constructor', () => {
    it('should set to email from user', () => {
      const mail = new EmailVerificationCodeMail(mockUser as UserModel, '123456', '2025-01-01 12:00:00');
  ...
  describe('properties', () => {
    it('should have correct subject and view', () => {
      const mail = new EmailVerificationCodeMail(mockUser as UserModel, '123456', '2025-01-01 12:00:00');
      expect(mail.subject).toBe('Email Verification Code - OneDosh');
      expect(mail.view).toBe('email_verification_code');
    });
  });
  ...
  describe('prepare', () => {
    ...
    it('should use first_name when username not provided', async () => {
      ...
      const mail = new EmailVerificationCodeMail(userWithoutUsername as UserModel, '123456', '2025-01-01 12:00:00');
      const data = await mail.prepare();
    ...
    it('should use default username when username and first_name not provided', async () => {
      ...
      const mail = new EmailVerificationCodeMail(userWithoutName as UserModel, '123456', '2025-01-01 12:00:00');
      const data = await mail.prepare();
