...
import { PhoneVerificationCodeMail } from './phone_verification_code_mail';

describe('PhoneVerificationCodeMail', () => {
  const mockUser = {
    id: 'user-123',
  ...
  describe('constructor', () => {
    it('should set to email from user', () => {
      const mail = new PhoneVerificationCodeMail(mockUser as UserModel, '123456', '2025-01-01 12:00:00');
  ...
  describe('properties', () => {
    it('should have correct subject and view', () => {
      const mail = new PhoneVerificationCodeMail(mockUser as UserModel, '123456', '2025-01-01 12:00:00');
      expect(mail.subject).toBe('Phone Verification Code - OneDosh');
      expect(mail.view).toBe('phone_verification_code');
    });
  });
  ...
  describe('prepare', () => {
    ...
    it('should use first_name when username not provided', async () => {
      ...
      const mail = new PhoneVerificationCodeMail(userWithoutUsername as UserModel, '123456', '2025-01-01 12:00:00');
      const data = await mail.prepare();
    ...
    it('should use default username when username and first_name not provided', async () => {
      ...
      const mail = new PhoneVerificationCodeMail(userWithoutName as UserModel, '123456', '2025-01-01 12:00:00');
      const data = await mail.prepare();
